...
public class ConjuntoConvidados {
  ...
  public static void main(String[] args) {
    ...
    conjuntoConvidados.adicionarConvidado("Levis", 1234);
    conjuntoConvidados.adicionarConvidado("Laurinha", 1235);
    conjuntoConvidados.adicionarConvidado("Domi", 1235); //convite clonado cm o mesmo codigo 
    conjuntoConvidados.adicionarConvidado("Ivan", 1236);
